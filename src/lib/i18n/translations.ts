...
export const translations = {
  ...
  "simulator.results.belowMinimum": { fr: "Minimum de commande : {{amount}} HT. Ajoutez des zones ou augmentez la durée pour atteindre ce montant.", en: "Minimum order: {{amount}} excl. VAT. Add zones or increase the duration to reach this amount.", zh: "最低订单金额:{{amount}}(不含税)。请增加区域或延长时长以达到该金额。", zhTW: "最低訂單金額:{{amount}}(不含稅)。請增加區域或延長時長以達到該金額。", es: "Pedido mínimo: {{amount}} sin IVA. Añada zonas o aumente la duración para alcanzar este importe.", ar: "الحد الأدنى للطلب: {{amount}} بدون ضريبة القيمة المضافة. أضف مناطق أو زد المدة للوصول إلى هذا المبلغ." },
