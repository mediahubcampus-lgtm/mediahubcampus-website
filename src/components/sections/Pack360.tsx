  ...
  return (
    <section id="pack360" className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-[var(--primary)]/20 border border-[var(--primary)]/30 rounded-full px-4 py-2 mb-6">
            ...
            {PACK_360.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-4 text-center hover:border-[var(--primary)]/50 transition-colors"
                >
